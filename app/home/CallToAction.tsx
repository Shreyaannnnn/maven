...
const CallToAction: React.FC = () => {
  return (
    <section className="flex flex-col self-center px-16 py-14 mt-32 w-full bg-orange-500 rounded-3xl max-w-[1131px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
