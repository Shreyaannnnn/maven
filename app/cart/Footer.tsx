...
const Footer: React.FC = () => {
  return (
    <footer className="mt-44 w-full max-w-[1240px] max-md:mt-10 max-md:max-w-full">
        ...
        <nav className="flex flex-col ml-5 w-[18%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col text-base leading-8 max-md:mt-10">
            ...
            <ul className="mt-3 text-white list-none p-0">
              ...
              <li>
                <a href="#teach">Teach On Maven House</a>
              </li>
              <li>
          ...
          <div className="flex flex-col items-start w-full text-base leading-8 text-white max-md:mt-10">
            ...
            <form className="w-full mt-7">
              ...
              <input
                ...
                className="w-full mt-2.5 bg-transparent border-b border-white opacity-60 pb-2 focus:outline-none focus:border-orange-500"
              />
              <button
                type="submit"
            ...
            <div className="mt-9">
              ...
              |
              <a href="#instagram" className="mx-4">
                Instagram
              </a>{" "}
              |
      ...
      <hr className="shrink-0 mt-12 max-w-full h-px bg-white border border-white border-solid opacity-50 w-[1240px] max-md:mt-10" />
      <p className="mt-5 text-base leading-8 text-white opacity-60">
        © 2023 Maven House
      </p>
    </footer>
  );
